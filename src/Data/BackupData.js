...
export const FAQ = [
  {
    ...
    description:
      "You can track your order by logging into your account and navigating to the 'Order History' section. There, you will find the tracking information for your current and past orders.",
  },
  {
    id: 502,
    title: "What should I do if my item is damaged upon delivery?",
    description:
      "If your item arrives damaged, please contact our customer support team within 24 hours of receiving the order. Provide details and, if possible, attach photos of the damaged item for our team to assess and assist you accordingly.",
  },
  {
    id: 503,
    title: "Can I change my shipping address after placing an order?",
    description:
      "Unfortunately, we cannot modify the shipping address once the order is confirmed. Please double-check your shipping information before completing your purchase to ensure accurate delivery.",
  },
  {
    id: 504,
    title: "What payment methods do you accept?",
    description:
      "We accept a variety of payment methods, including credit/debit cards, digital wallets, and other secure payment options. You can view the available payment methods during the checkout process.",
  },
  {
    id: 505,
    title: "Do you offer international shipping?",
    description:
      "Currently, we only offer shipping within [Your Country]. We do not provide international shipping services at this time. Please check our shipping policy for more details.",
  },
  {
    id: 506,
    title: "How can I return an item?",
    description:
      "If you're not satisfied with your purchase, you can initiate a return by going to the 'Returns' section in your account. Follow the provided instructions to return the item within the specified return window.",
  },
  {
    id: 507,
    title: "Are there any additional charges for returns?",
    description:
      "Returns are generally free of charge within the designated return period. However, if the return is initiated outside of this period, or if the item is not in its original condition, additional charges may apply. Refer to our return policy for more information.",
  },
  {
    id: 508,
    title: "How can I contact customer support?",
    description:
      "For any inquiries or assistance, you can reach our customer support team at [Your Customer Support Email] or call us at [Your Customer Support Phone Number]. Our dedicated team is available to help you during our business hours.",
  },
];

export const BackupDataProducts = [
  {
    products: [
      {
        id: 1,
...
export const BackupDataCategories = [
  "smartphones",
  "laptops",
  "fragrances",
  "skincare",
